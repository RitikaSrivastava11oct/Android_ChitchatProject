...
public class serch_recy extends AppCompatActivity {
    EditText e1;
    RecyclerView rv;
    ImageView i1;
...
class abc extends RecyclerView.Adapter<abc.iner>{
List<messages> l;
String uid;
    user u;
    public abc(List l,String uid,user u)
    {
        this.l=l;
        this.uid=uid;
        this.u=u;
